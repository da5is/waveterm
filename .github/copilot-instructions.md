...
| sync-upstream | `.kilocode/skills/sync-upstream/SKILL.md` | Guide for syncing this fork with the official wavetermdev/waveterm upstream repository. Use when merging upstream changes, resolving fork conflicts, or bringing the fork up to date.                                                       |
